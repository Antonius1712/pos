                ...
                <form action="{{ route('admin.transaksi.store') }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="customer_id" id="customer_id" class="form-control select2" style="display: block;"required>
                        ...
                        <table class="table table-bordered table-hover table-nowrap">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="metode_bayar" id="metode_bayar" class="form-control select2" required>
...
@section('script')
    ...
    <script>
        ...
        $('body').on('keypress', '#discount', function(event){
            if (event.keyCode === 13) {
                $('#grandTotal').focus();
                return false;
            }
        ...
        $('body').on('click', '#new_customer_checkbox', function(){
            ...
            $('#new_customer').prop('required', true);
        ...
        $('body').on('click', '#old_patient_checkbox', function(){
            ...
            $('#new_customer').prop('required', false);
